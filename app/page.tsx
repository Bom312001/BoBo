...
export default function Home() {
  ...
  const startGame = () => {
    let indices = Array.from({ length: sentences.length }, (_, i) => i);
        ...
        {currentSentence ? (
          <div>
            <div className="flex items-center justify-center gap-3">
              ...
              {/* 🎧 Đọc tiếng Trung chuẩn */}
              <button
                onClick={() =>
                  currentSentence && speakChinese(currentSentence.zh)
                }
            ...
            {(showTranslation || isCorrect === true) && (
